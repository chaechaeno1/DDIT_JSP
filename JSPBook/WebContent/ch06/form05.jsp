            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="content-left wow fadeInLeft" data-wow-delay=".3s">
						...
						<!-- form태그 내 action이 설정되어있지않으면, 
						지금 보고 있는 브라우저의 url 주소에 데이터가 저장됨-->
						<form method="post" action="form05_process.jsp">
							...
							가입인사 : <textarea rows="20" cols="50" name="comment" 
									wrap="hard" placeholder="가입인사를 입력해주세요."></textarea>		
							...
							<!--
								...
								해당 속성은 html5에 새롭게 추가된 기능입니다.
								wrap = "hard" 속성 사용 시, cols 속성이 꼭 명시되어 있어야 한다.
								
								wrap 속성의 hard로 설정 시, textarea 설정 크기 안에서 Enter를 치지 않고 텍스트를 입력해 나갈때
								textarea 가로 길이 오른족 맨 끝에 다다를때 자동으로 아래줄로 넘어가 작성이 되는데 이때 Enter를 직접 치지는
								않았지만 아래줄로 내려가 작성되기 때문에 그 부분에 개행 문자가 부여될 수 있게 해준다.
							 	...
							 	hard 설정은 개행 문자가 포함되서 넘어간다고 공식문에서도 설명하고 있지만,
