            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="content-left wow fadeInLeft" data-wow-delay=".3s">
						...
						<h3>JavaScript 버전</h3>
						<form name="loginForm" action="vaildation02_process.jsp">
						...
						<h3>Jquery 버전</h3>
						<form name="loginForm2" id="loginForm2" action="vaildation02_process.jsp">
...
function CheckForm(){
	...
	//아이디가 입력 되었는지 검사
	//아이디가 입력되지 않으면 오류 메세지를 출력 해당 입력 항목에 커서가 놓인다.
	if(form.id.value == ""){
		alert("아이디를 입력해주세요.");
		form.id.focus();
		return false;
	...
	//비밀번호가 입력 되었는지 검사
	//비밀번호 입력되지 않으면 오류 메세지를 출력 해당 입력 항목에 커서가 놓인다.
	if(form.pw.value == ""){
		alert("아이디를 입력해주세요.");
		form.pw.focus();
		return false;
