            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="content-left wow fadeInLeft" data-wow-delay=".3s">
						...
						-->
						<form name="form" id="frm" action="./ch08_test_process.jsp" method="post">
...
function CheckMember(){
	...
	//숫자만 입력하되, 7-12자리까지만 입력 받을 수 있게(O)
	var regExpQuest1 = /^[0-9]{7,12}$/;	
	//시작은 영소문자 abc고 영소대문자 8-12자리까지만 입력 받을 수 있게(?)
	var regExpQuest2 = /^[abc][a-zA-Z]{8,12}$/;	
	//아이디는 영소문자로 시작하고 영소문자,숫자  8~16자(O)
	var regExpQuest3 = /^[a-z][a-z0-9]{8,16}$/;
	//비밀번호는 영대문자로 시작하고 영문 대 소문자, 숫자, 특수문자  8~16자(O)
	var regExpQuest4 = /^[A-Z][A-Za-z0-9-_\.]{8,16}$/;
	//이름은 한글 2-5글자로 설정(O)
	var regExpQuest5 = /^[가-힣]{2,5}$/;
	//핸드폰 번호의 첫번째 자리는 011,016,017,019,070,010 으로 시작하고 
	//두번째 자리는 숫자 3자리 또는 숫자 4자리로 시작하고<br/>
	//세번째 자리는 숫자 4자리 (?)
	var regExpQuest6 = /^[011|016|017|019|070|010]-\d{3,4}-\d{4}$/;
	...
	if(!regExpQuest1.test(Q1)){
		$("#err_quest1").html('<font color="red">숫자만 입력하되, 7-12자리까지만 입력 받을 수 있게 설정해주세요.</font>');
		form.quest1.select();
		return false;
	}else{
		$("#err_quest1").html('<font color="green">정상!</font>');	
	}
