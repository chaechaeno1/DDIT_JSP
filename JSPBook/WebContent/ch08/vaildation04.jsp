            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="content-left wow fadeInLeft" data-wow-delay=".3s">
						...
						<h3>JavaScript 버전</h3>
						<form name="loginForm" action="vaildation04_process.jsp">
						...
						<h3>Jquery 버전</h3>
						<form name="loginForm2" id="loginForm2" action="vaildation04_process.jsp">
...
function CheckForm(){
	...
	for(i = 0; i < form.id.value.length; i++){
		...
		// || 연산 : true false일 때 true 이다. (즉, 하나라도 true면 true)
		// && 연산 : true false일 때 false 이다. (즉, 모두 ture면 true)
