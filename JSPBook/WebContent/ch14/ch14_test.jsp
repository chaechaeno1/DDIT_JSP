                ...
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="content-left wow fadeInLeft" data-wow-delay=".3s">
						...
						<!-- 
							...
							다시 로그인 페이지를 reload하면 아이디 저장이 체크가 되어 있고
							아이디 입력란에 아이디가 입력된 상태에 로그인 페이지가 나타나게 해주세요.
							
							아이디 저장 체크를 하지 않고 로그인 성공 시 쿠키를 저장하지 않고
							다시 로그인 페이지를 reload했을 때, 아이디 저장이 체크가 되어있지 않은 상태로
							페이지가 나타나게 해주세요.
						...
						%>
						 ...
						 <form action="ch14_test_process.jsp" method="post">
							...
							아이디 저장 <input type="checkbox" name="chk" value="Y"
								<%if(cookieFlag){%> checked="checked"<%}%>><br>
